...
#         print('dit',dit[mutname]+1)
         if num != 0 and pssm[num][1]==wildname:

           feature_pssm[0,0]=pssm[num][dit[wildname]+1]
           feature_pssm[0,1]=pssm[num][dit[mutname]+1]
